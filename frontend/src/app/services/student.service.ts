...
import { STUDENTI_NA_DEPARTMANU_URL, STUDENT_URL } from '../app.constants';
...
export class StudentService {
  ...
  public getStudentsForDepartman(idDepartmana: number): Observable<any> {
    return this.httpClient.get(`${STUDENTI_NA_DEPARTMANU_URL}/${idDepartmana}`);
  }
